...
const PrivacyPolicy = () => {
  return (
    <>
        ...
        {(mode) => (
          <main className='privacy-policy'>
            ...
            <ul>
              ...
              <li>Application refers to Wifi Share, the software program provided by the Company.</li>

              <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Wifi Share.</li>

              <li>Country refers to: Maharashtra, India</li>
      ...
      <Helmet>
          <title>Privacy Policy | Pranav Joglekar</title>
